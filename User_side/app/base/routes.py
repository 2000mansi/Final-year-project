...
def send_link():
    ...
    fromaddr = "mansikela2000@gmail.com"
    toaddr = "payaldas217@gmail.com"
    ...
    server.starttls()
    server.login("mansikela2000@gmail.com", "praxcqokcrwouzlq")
...
def send_prescription():
    ...
    server = smtplib.SMTP('smtp.gmail.com', port=587)
    server.starttls()
    server.login(fromaddr, "praxcqokcrwouzlq")
